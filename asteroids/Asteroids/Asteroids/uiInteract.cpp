...
void Interface::keyEvent()
{
   ...
   if (isRightPress)
      isRightPress++;
   isSpacePress = false;
   isTPress = false; // implement T bottom
   isCPress = false; // implement C bottom
}
...
bool         Interface::isTPress = false; // implement T bottom
bool         Interface::isCPress = false; // implement C bottom
